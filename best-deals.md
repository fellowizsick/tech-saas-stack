...
- **Status**: ✅ Verified (HTTP 301 on HEAD, final 200 on GET — redirect chain resolves to affiliate_program.htm with afcode param intact as of Aug 24; status fluctuates behind Cloudflare WAF (202 Jul 11, 301→200 Jul 31, 301 Aug 23). Link functional in browser; affiliate redirect chain intact. StartUp $2.99/mo intro + save up to 83% + free domain/site transfer promo live.)
...
- **Status**: ✅ Verified (HTTP 403 — Cloudflare WAF bot-block on automated checks as of Aug 24; affiliate ID `1155259` intact, link SACRED and working for real users. Affiliate redirect previously passed at HTTP 302. Pricing: $2.50 first month / $7/mo renewal monthly; annual/2-yr prepay locks in $2.50/mo.)
...
- **Cookie Duration**: 90 days
- **Status**: ✅ Verified (HTTP 403 — Cloudflare WAF bot-block on Aug 24 automated check (was 200 Jul 31; behavior intermittent as documented Jul 10-11). Affiliate tracking ID `2179745` active, link SACRED and working for real users. $11/mo starting price.)
...
- **Cookie Duration**: 60 days
- **Status**: ✅ Verified (HTTP 302 — Impact Radius redirect resolves cleanly (final 200) as of Aug 24; official WordPress.org recommended host.)
...
- **Status**: ✅ Verified (HTTP 301→200 — www canonical redirect, GET resolves final 200 as of Aug 24. VPS commissions: $120–$200+/sale, web hosting: $50–$100+/sale. Affiliate ID `aid=7ff57600` confirmed active. VPS starting at $29.95/mo intro.)
...
- **Status**: ✅ Verified (HTTP 200 — reachable via GET as of Aug 24; HEAD requests return 403 (WAF quirk). "SEO" plan (replaces old "Pro") at $139/mo monthly / $117.33/mo annual. Tiers: SEO $139, Starter $199, Pro+ $299, Advanced $549. Task spec $129/mo Pro outdated — $139 SEO confirmed. Pricing page JS-rendered — value kept from prior verified pass.)
...
- **Cookie Duration**: 90 days
- **Status**: ✅ Verified (HTTP 200 as of Aug 24. Essential plan $49/yr annual billing (page also shows a $59/yr figure in places, likely a different tier/promo). Advanced Solo at $84/yr ($7/mo). Pricing page JS-rendered — values kept from prior verified pass.)
...
- **Cookie Duration**: 90 days
- **Status**: ✅ Verified (HTTP 200 as of Aug 24. Pricing page JS-rendered — $15/mo kept from prior verified pass.)
...
- **Ahrefs**: No active public affiliate program found (ahrefs.com/affiliates returns HTTP 404, re-confirmed Jul 31). Pricing: Lite plan "From $99/mo" (task spec $99/mo CONFIRMED, re-verified Aug 24 on ahrefs.com/pricing). Keep unlisted as no active affiliate program.
- **SiteGround**: HTTP 301 on HEAD Aug 24 — GET resolves final 200 at affiliate_program.htm with afcode param intact. Status fluctuates behind Cloudflare WAF (202 Jul 11 → 301→200 Jul 31 → 301 Aug 23). Link functional in browser. StartUp at $2.99/mo intro, renews $17.99/mo. Save up to 83% + free domain + free site transfer promo live.
- **InterServer**: HTTP 403 — Cloudflare WAF bot-block on automated checks as of Aug 24; affiliate ID `1155259` intact, link SACRED (working for real users). Affiliate redirect previously passed at 302. Pricing: $2.50 first month / $7/mo renewal on monthly. Annual prepay locks at $30/yr ($2.50/mo).
- **Semrush**: HTTP 200 via GET (HEAD 403 WAF quirk) confirmed Aug 24. Pricing stable: SEO plan $139/mo monthly / $117.33/mo annual. Tiers: SEO $139, Starter $199, Pro+ $299, Advanced $549. ("+$149/mo" raw-HTML fragment = MCP add-on, not core plan pricing.)
- **Cloudways**: HTTP 403 (Cloudflare WAF) on Aug 24 — WAF re-engaged after the Jul 31 window when it was 200; behavior intermittent (was 403 Jul 10-11, 200 Jul 31). Affiliate tracking ID `2179745` confirmed, link SACRED and working for real users. $11/mo starting per affiliate dashboard.
- **Kinsta**: $35/mo monthly billing re-confirmed Aug 24 — pricing page shows $35/mo dominant (13× vs 4× $30/mo). Annual $350/yr saves $70 vs monthly ($420). Task spec $35/mo CONFIRMED; "$30/month" seen on pricing page is the annual-effective rate, not current monthly price.
- **ScalaHosting**: HTTP 301→200 — www canonical redirect, GET final 200 as of Aug 24. VPS starting at $29.95/mo intro. Commission tiers stable. Affiliate ID `aid=7ff57600` active.
